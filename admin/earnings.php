...
<section class="home-category">
   ...
   <?php
            ...
            $commsql = "SELECT sum(commission) as tot FROM `earnings`";
            
            $commsqlresult = $conn->query($commsql);
            if ($commsqlresult->num_rows > 0) {
                while($totrow = $commsqlresult->fetch_assoc()) 
                {
                    echo '
                    
                          <h2 class="title">Total Site Commission - '.$totrow['tot'].' LKR</h2>'
                     ;                                                   
              ...
              <h2 class="title">Total Site Commission - 0 LKR</h2>'
         ; 
            }
   ...
   <div class="">
        ...
        <?php
            ...
            $itemsql = "SELECT * FROM `earnings` join orders on earnings.orderid=orders.id where orders.status='Approved'";
